...
- **경계 표시 + 드래그 배치**: 각 요소의 실제 영역이 기본으로 표시되고(줌바 "경계"로 끄기 가능), 박스를 끌어 위치를 정합니다. 다른 요소와 수평/수직이 맞으면 가이드라인 스냅, 더블클릭으로 초기화. 하단 공간은 경계선, 인스탁스 테두리 여백은 사진 우상단 모서리 그립을 끌어 조절하며 왼쪽·아래로 끌수록 여백이 커집니다. 마지막 요소 이동·크기·수치·프리셋·초기화는 줌바의 **돌아가기**로 한 번 되돌릴 수 있습니다
